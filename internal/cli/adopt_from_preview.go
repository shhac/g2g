...
// adoptFromView leads with the authority claim rather than the branch count.
//
...
// before typing --apply.
func adoptFromView(plan align.AdoptPlan) stackView {
	source := adoptedFrom(plan.From)
...
func adoptedFrom(from string) adoptSource {
